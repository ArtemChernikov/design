 ...
 * Класс должен запускаться с входными параметрами запуска например:
 ...
 * Используется класс {@link ArgsName} - для валидции входных параметров и получения значения по ключу
 *
